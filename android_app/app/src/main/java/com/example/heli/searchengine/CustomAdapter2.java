...
public class CustomAdapter2 extends BaseAdapter {
    ...
    private ArrayList<Main4Activity.Documents> documentsArrayList;

    public CustomAdapter2(Context context, ArrayList<Main4Activity.Documents> documentsArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(documentsArrayList.size()<=0)
        {
            ...
            Main4Activity.Documents document=documentsArrayList.get(position);
