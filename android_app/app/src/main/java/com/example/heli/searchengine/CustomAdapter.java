...
public class CustomAdapter extends BaseAdapter {
    ...
    private ArrayList<Main2Activity.Documents> documentsArrayList;

    public CustomAdapter(Context context, ArrayList<Main2Activity.Documents> documentsArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(documentsArrayList.size()<=0)
        {
            ...
            Main2Activity.Documents document=documentsArrayList.get(position);
            ...
            //holder.imageView.setImageURI(document.thumbnail);
